...
To build the final jar and optimize the Radagast application for production, run:
...
Then navigate to [http://localhost:9876](http://localhost:9876) in your browser.
