...
export class OrgComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.orgService
      ...
      .subscribe(
        (res: HttpResponse<IOrg[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInOrgs(): void {
    this.eventSubscriber = this.eventManager.subscribe('orgListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IOrg[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
