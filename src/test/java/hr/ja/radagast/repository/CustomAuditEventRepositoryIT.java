...
import hr.ja.radagast.config.audit.AuditEventConverter;
import hr.ja.radagast.domain.PersistentAuditEvent;
...
import static hr.ja.radagast.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
